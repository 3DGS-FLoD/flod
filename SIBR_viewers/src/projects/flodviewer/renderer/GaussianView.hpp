...
namespace sibr { 
	...
	protected:
		...
		bool _levelRendering = true;
		bool _selectiveRendering = false;
		std::string renderLevel;
		std::string previousRenderLevel;
		...
		void onRenderLevelChanged(const std::string& renderLevel);
	};
